...
function descriptografar() {
     ...
     document.getElementById('output').innerHTML = `<textarea readonly id= "input-texto">${resultDescripto}</textarea><button class="btn-descripto" id= "copiar" onclick= "copiar()">Copiar</button>`
}